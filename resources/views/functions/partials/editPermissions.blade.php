<div class="modal fade bs-edit-modal-lg{{ $permission->id }}" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form class="form-horizontal" method="post" action="{{ action('PermissionsController@editPermission', ['id'=>$permission->id]) }}">
                        {!! csrf_field() !!}
